  ...
  breakdown: [
    {
      ...
      video: { url: "https://www.youtube.com/watch?v=OavvDwjWU58", title: "AI & Privacy: What Happens to Your Data After You Paste It Into ChatGPT", channel: "The GRAPH Courses" },
      caption:
        'Your prompt leaves your device, crosses the internet, and is logged and briefly kept on provider servers. The big question is whether it trains future models.',
      svg:
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 200" width="100%" preserveAspectRatio="xMidYMid meet" role="img" font-family="system-ui, -apple-system, Helvetica, Arial, sans-serif"><title>Where your prompt goes after you send it</title><defs><marker id="arP1" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="#6b7280"/></marker></defs><rect x="0" y="0" width="360" height="200" rx="10" fill="#f7f3ea"/><text x="180" y="24" text-anchor="middle" font-size="14" font-weight="700" fill="#1c1d1f">Where your prompt goes</text><rect x="16" y="78" width="86" height="56" rx="6" fill="#ffffff" stroke="#e6dfce" stroke-width="1.5"/><text x="59" y="102" text-anchor="middle" font-size="11" font-weight="700" fill="#1c1d1f">Your device</text><text x="59" y="118" text-anchor="middle" font-size="9.5" fill="#6b7280">your prompt</text><line x1="104" y1="106" x2="142" y2="106" stroke="#6b7280" stroke-width="1.6" marker-end="url(#arP1)"/><text x="123" y="98" text-anchor="middle" font-size="9" fill="#6b7280">internet</text><rect x="146" y="66" width="138" height="84" rx="8" fill="#efe9da" stroke="#0b5394" stroke-width="1.6"/><text x="215" y="86" text-anchor="middle" font-size="11" font-weight="700" fill="#0b5394">Provider servers</text><rect x="160" y="96" width="8" height="8" rx="1.5" fill="#6b7280"/><text x="174" y="103" font-size="9.5" fill="#1c1d1f">logged</text><rect x="160" y="113" width="8" height="8" rx="1.5" fill="#6b7280"/><text x="174" y="120" font-size="9.5" fill="#1c1d1f">retained briefly</text><rect x="160" y="130" width="8" height="8" rx="1.5" fill="#6b7280"/><text x="174" y="137" font-size="9.5" fill="#1c1d1f">reviewed at times</text><text x="180" y="180" text-anchor="middle" font-size="10" font-weight="700" fill="#d97706">Key question: will it train future models?</text></svg>',
      explanation:
    ...
    },
    {
      ...
      video: { url: "https://www.youtube.com/watch?v=3aekyhtXM9A", title: "Enterprise AI Security: Stop Your Data from Being Used to Train AI Models", channel: "Juma" },
      caption:
        'The same company can offer opposite privacy rules by tier. Consumer plans may train on your chats, while business and API plans usually promise no training and short retention.',
      svg:
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 200" width="100%" preserveAspectRatio="xMidYMid meet" role="img" font-family="system-ui, -apple-system, Helvetica, Arial, sans-serif"><title>Consumer terms versus business and API terms</title><rect x="0" y="0" width="360" height="200" rx="10" fill="#f7f3ea"/><text x="180" y="24" text-anchor="middle" font-size="14" font-weight="700" fill="#1c1d1f">Same brand, different terms</text><rect x="18" y="46" width="158" height="118" rx="8" fill="#ffffff" stroke="#e6dfce" stroke-width="1.5"/><rect x="18" y="46" width="6" height="118" rx="3" fill="#d97706"/><text x="100" y="70" text-anchor="middle" font-size="12" font-weight="700" fill="#1c1d1f">Consumer</text><text x="36" y="94" font-size="10" fill="#d97706">may train on chats</text><text x="36" y="114" font-size="10" fill="#1c1d1f">opt-out you must set</text><text x="36" y="134" font-size="10" fill="#6b7280">free or personal use</text><rect x="184" y="46" width="158" height="118" rx="8" fill="#ffffff" stroke="#e6dfce" stroke-width="1.5"/><rect x="336" y="46" width="6" height="118" rx="3" fill="#1f7a50"/><text x="263" y="70" text-anchor="middle" font-size="12" font-weight="700" fill="#0b5394">Enterprise / API</text><text x="202" y="94" font-size="10" fill="#1f7a50">no training by default</text><text x="202" y="114" font-size="10" fill="#1c1d1f">limited retention</text><text x="202" y="134" font-size="10" fill="#1c1d1f">signed data agreement</text><text x="180" y="184" text-anchor="middle" font-size="9.5" fill="#6b7280">The tier you are on decides, not the brand</text></svg>',
      explanation:
    ...
    },
    {
      ...
      video: { url: "https://www.youtube.com/watch?v=Onr8WtBNrws", title: "ChatGPT Is Using Your Sensitive Data... Unless You Do This", channel: "Proper Project Management" },
      caption:
        'Whatever you send, including names, keys, and files, is kept for a window before deletion. Once it leaves, you cannot fully recall it.',
      svg:
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 200" width="100%" preserveAspectRatio="xMidYMid meet" role="img" font-family="system-ui, -apple-system, Helvetica, Arial, sans-serif"><title>Sensitive data is retained for a window before deletion</title><defs><marker id="arP3" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="#6b7280"/></marker></defs><rect x="0" y="0" width="360" height="200" rx="10" fill="#f7f3ea"/><text x="180" y="24" text-anchor="middle" font-size="14" font-weight="700" fill="#1c1d1f">What you send is kept, then deleted</text><rect x="16" y="62" width="130" height="92" rx="8" fill="#ffffff" stroke="#e6dfce" stroke-width="1.5"/><text x="81" y="80" text-anchor="middle" font-size="11" font-weight="700" fill="#1c1d1f">Your prompt</text><rect x="28" y="88" width="106" height="17" rx="4" fill="#efe9da" stroke="#dc2626" stroke-width="1.2"/><text x="34" y="100" font-size="8.5" fill="#dc2626">name + address (PII)</text><rect x="28" y="110" width="106" height="17" rx="4" fill="#efe9da" stroke="#dc2626" stroke-width="1.2"/><text x="34" y="122" font-size="8.5" fill="#dc2626">API key (secret)</text><rect x="28" y="132" width="106" height="17" rx="4" fill="#efe9da" stroke="#e6dfce" stroke-width="1.2"/><text x="34" y="144" font-size="8.5" fill="#1c1d1f">confidential file</text><line x1="150" y1="108" x2="182" y2="108" stroke="#6b7280" stroke-width="1.6" marker-end="url(#arP3)"/><text x="166" y="100" text-anchor="middle" font-size="9" fill="#6b7280">kept</text><rect x="186" y="62" width="158" height="92" rx="8" fill="#efe9da" stroke="#0b5394" stroke-width="1.6"/><text x="265" y="80" text-anchor="middle" font-size="10.5" font-weight="700" fill="#0b5394">Provider keeps a copy</text><text x="265" y="100" text-anchor="middle" font-size="8.5" fill="#6b7280">retention window</text><line x1="204" y1="116" x2="326" y2="116" stroke="#6b7280" stroke-width="1.6"/><circle cx="204" cy="116" r="4" fill="#1f7a50"/><circle cx="326" cy="116" r="4" fill="#dc2626"/><text x="204" y="134" text-anchor="middle" font-size="9" fill="#1c1d1f">sent</text><text x="326" y="134" text-anchor="middle" font-size="9" fill="#dc2626">deleted</text><text x="180" y="184" text-anchor="middle" font-size="9.5" fill="#dc2626">Once sent, you cannot fully recall it</text></svg>',
      explanation:
    ...
    },
    {
      ...
      video: { url: "https://www.youtube.com/watch?v=TGEC5ev0iT8", title: "Protecting Sensitive Data from Generative AI Tools", channel: "Data Zen Community" },
      caption:
        'Clean each prompt before it goes out by redacting, minimizing, and gating access. Broad privacy law and stricter sector rules sit over the whole flow.',
      svg:
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 200" width="100%" preserveAspectRatio="xMidYMid meet" role="img" font-family="system-ui, -apple-system, Helvetica, Arial, sans-serif"><title>Safeguards applied before a prompt is sent</title><defs><marker id="arP4" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="#6b7280"/></marker></defs><rect x="0" y="0" width="360" height="200" rx="10" fill="#f7f3ea"/><text x="180" y="24" text-anchor="middle" font-size="14" font-weight="700" fill="#1c1d1f">Safeguards before you send</text><rect x="46" y="38" width="268" height="22" rx="6" fill="#efe9da" stroke="#e6dfce" stroke-width="1.2"/><text x="180" y="53" text-anchor="middle" font-size="9.5" fill="#0b5394">Rules: broad privacy law + stricter sector rules</text><rect x="14" y="92" width="58" height="46" rx="6" fill="#ffffff" stroke="#e6dfce" stroke-width="1.5"/><text x="43" y="112" text-anchor="middle" font-size="9.5" font-weight="700" fill="#1c1d1f">Raw</text><text x="43" y="125" text-anchor="middle" font-size="9.5" font-weight="700" fill="#1c1d1f">data</text><line x1="74" y1="115" x2="84" y2="115" stroke="#6b7280" stroke-width="1.5" marker-end="url(#arP4)"/><rect x="86" y="92" width="58" height="46" rx="6" fill="#ffffff" stroke="#1f7a50" stroke-width="1.5"/><text x="115" y="111" text-anchor="middle" font-size="9.5" font-weight="700" fill="#1f7a50">Redact</text><text x="115" y="125" text-anchor="middle" font-size="8" fill="#6b7280">mask IDs</text><line x1="146" y1="115" x2="156" y2="115" stroke="#6b7280" stroke-width="1.5" marker-end="url(#arP4)"/><rect x="158" y="92" width="58" height="46" rx="6" fill="#ffffff" stroke="#1f7a50" stroke-width="1.5"/><text x="187" y="111" text-anchor="middle" font-size="9.5" font-weight="700" fill="#1f7a50">Minimize</text><text x="187" y="125" text-anchor="middle" font-size="8" fill="#6b7280">send less</text><line x1="218" y1="115" x2="228" y2="115" stroke="#6b7280" stroke-width="1.5" marker-end="url(#arP4)"/><rect x="230" y="92" width="60" height="46" rx="6" fill="#ffffff" stroke="#0b5394" stroke-width="1.5"/><text x="260" y="111" text-anchor="middle" font-size="9.5" font-weight="700" fill="#0b5394">Access</text><text x="260" y="125" text-anchor="middle" font-size="8" fill="#6b7280">control + log</text><line x1="292" y1="115" x2="300" y2="115" stroke="#6b7280" stroke-width="1.5" marker-end="url(#arP4)"/><rect x="302" y="92" width="46" height="46" rx="6" fill="#efe9da" stroke="#0b5394" stroke-width="1.6"/><text x="325" y="118" text-anchor="middle" font-size="9.5" font-weight="700" fill="#0b5394">Model</text><text x="180" y="184" text-anchor="middle" font-size="9" fill="#6b7280">Vendor check: terms, security, sub-processors</text></svg>',
      explanation:
