  ...
  breakdown: [
    {
      ...
      video: { url: "https://www.youtube.com/watch?v=LPZh9BOjkQs", title: "Large Language Models explained briefly", channel: "3Blue1Brown" },
      caption:
        'A model trains on a huge amount of text, stores what it learns in billions of parameters, then uses that to generate new writing, answers, and code.',
      svg:
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 200" width="100%" preserveAspectRatio="xMidYMid meet" role="img" font-family="system-ui, -apple-system, Helvetica, Arial, sans-serif"><title>A large language model learns from text and generates text</title><defs><marker id="arI1" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="#6b7280"/></marker></defs><rect x="0" y="0" width="360" height="200" rx="10" fill="#f7f3ea"/><text x="180" y="24" text-anchor="middle" font-size="14" font-weight="700" fill="#1c1d1f">What a large language model is</text><rect x="16" y="70" width="78" height="64" rx="6" fill="#ffffff" stroke="#e6dfce" stroke-width="1.5"/><line x1="28" y1="86" x2="82" y2="86" stroke="#6b7280" stroke-width="1.5"/><line x1="28" y1="98" x2="82" y2="98" stroke="#6b7280" stroke-width="1.5"/><line x1="28" y1="110" x2="82" y2="110" stroke="#6b7280" stroke-width="1.5"/><line x1="28" y1="122" x2="64" y2="122" stroke="#6b7280" stroke-width="1.5"/><text x="55" y="152" text-anchor="middle" font-size="11" fill="#1c1d1f">Training text</text><text x="55" y="166" text-anchor="middle" font-size="9.5" fill="#6b7280">trillions of words</text><line x1="98" y1="102" x2="128" y2="102" stroke="#6b7280" stroke-width="1.6" marker-end="url(#arI1)"/><rect x="132" y="74" width="96" height="56" rx="8" fill="#efe9da" stroke="#0b5394" stroke-width="1.6"/><text x="180" y="98" text-anchor="middle" font-size="12" font-weight="700" fill="#0b5394">LLM</text><text x="180" y="113" text-anchor="middle" font-size="9.5" fill="#6b7280">billions of parameters</text><text x="180" y="150" text-anchor="middle" font-size="9.5" fill="#6b7280">predicts next text</text><line x1="232" y1="102" x2="262" y2="102" stroke="#6b7280" stroke-width="1.6" marker-end="url(#arI1)"/><rect x="266" y="70" width="80" height="64" rx="6" fill="#ffffff" stroke="#e6dfce" stroke-width="1.5"/><text x="306" y="88" text-anchor="middle" font-size="10" fill="#1f7a50">write</text><text x="306" y="103" text-anchor="middle" font-size="10" fill="#1f7a50">answer</text><text x="306" y="118" text-anchor="middle" font-size="10" fill="#1f7a50">summarize</text><text x="306" y="133" text-anchor="middle" font-size="10" fill="#1f7a50">code</text><text x="306" y="152" text-anchor="middle" font-size="9.5" fill="#6b7280">generated text</text></svg>',
      explanation:
    ...
    },
    {
      ...
      caption:
        'The model scores likely next tokens, picks one, adds it to the running text, then repeats. That loop turns one guess at a time into whole sentences.',
      svg:
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 200" width="100%" preserveAspectRatio="xMidYMid meet" role="img" font-family="system-ui, -apple-system, Helvetica, Arial, sans-serif"><title>Next-token prediction generates one token at a time in a loop</title><style>.i2pick{animation:i2pulse 2.4s ease-in-out infinite}@keyframes i2pulse{0%,100%{opacity:1}50%{opacity:.55}}@media (prefers-reduced-motion: reduce){.i2pick{animation:none}}</style><defs><marker id="arI2" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="#6b7280"/></marker><marker id="arI2g" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="#1f7a50"/></marker></defs><rect x="0" y="0" width="360" height="200" rx="10" fill="#f7f3ea"/><text x="180" y="22" text-anchor="middle" font-size="14" font-weight="700" fill="#1c1d1f">Next-token prediction</text><rect x="40" y="34" width="196" height="28" rx="6" fill="#ffffff" stroke="#e6dfce" stroke-width="1.5"/><text x="138" y="52" text-anchor="middle" font-size="11" fill="#1c1d1f">The cat sat on the</text><rect x="240" y="36" width="22" height="24" rx="3" fill="#efe9da" stroke="#2f8cff" stroke-width="1.5"/><text x="251" y="53" text-anchor="middle" font-size="12" fill="#2f8cff">?</text><line x1="120" y1="62" x2="120" y2="80" stroke="#6b7280" stroke-width="1.5" marker-end="url(#arI2)"/><text x="120" y="94" text-anchor="middle" font-size="9.5" fill="#6b7280">probability of next token</text><text x="96" y="113" text-anchor="end" font-size="10" fill="#1c1d1f">mat</text><rect class="i2pick" x="102" y="105" width="120" height="11" rx="2" fill="#2f8cff"/><text x="228" y="114" font-size="9.5" fill="#6b7280">0.61</text><text x="96" y="131" text-anchor="end" font-size="10" fill="#1c1d1f">rug</text><rect x="102" y="123" width="48" height="11" rx="2" fill="#6b7280" opacity="0.35"/><text x="156" y="132" font-size="9.5" fill="#6b7280">0.18</text><text x="96" y="149" text-anchor="end" font-size="10" fill="#1c1d1f">floor</text><rect x="102" y="141" width="24" height="11" rx="2" fill="#6b7280" opacity="0.35"/><text x="132" y="150" font-size="9.5" fill="#6b7280">0.09</text><path d="M222,146 C310,142 312,40 264,46" fill="none" stroke="#1f7a50" stroke-width="1.5" stroke-dasharray="4 3" marker-end="url(#arI2g)"/><text x="180" y="180" text-anchor="middle" font-size="10" fill="#1f7a50">pick, append, then predict again</text></svg>',
      explanation:
    ...
    },
    {
      ...
      video: { url: "https://www.youtube.com/watch?v=K7o5_Fj7_SY", title: "Brief History of Large Language Models & Generative AI | Evolution of NLP from Eliza to ChatGPT", channel: "Analytics Vidhya" },
      caption:
        'Language tech moved through four eras: hand-written rules, word-counting statistics, the 2017 transformer, then instruction-tuned chat models around 2022.',
      svg:
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 200" width="100%" preserveAspectRatio="xMidYMid meet" role="img" font-family="system-ui, -apple-system, Helvetica, Arial, sans-serif"><title>A short history of language models in four eras</title><defs><marker id="arI3" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="#6b7280"/></marker></defs><rect x="0" y="0" width="360" height="200" rx="10" fill="#f7f3ea"/><text x="180" y="26" text-anchor="middle" font-size="14" font-weight="700" fill="#1c1d1f">A short history</text><line x1="30" y1="110" x2="334" y2="110" stroke="#6b7280" stroke-width="1.6" marker-end="url(#arI3)"/><circle cx="60" cy="110" r="7" fill="#0b5394"/><text x="60" y="90" text-anchor="middle" font-size="11.5" font-weight="700" fill="#1c1d1f">Rules</text><text x="60" y="132" text-anchor="middle" font-size="9.5" fill="#6b7280">1960s</text><text x="60" y="145" text-anchor="middle" font-size="9.5" fill="#6b7280">ELIZA</text><circle cx="145" cy="110" r="7" fill="#0b5394"/><text x="145" y="90" text-anchor="middle" font-size="11.5" font-weight="700" fill="#1c1d1f">Statistics</text><text x="145" y="132" text-anchor="middle" font-size="9.5" fill="#6b7280">n-grams</text><circle cx="230" cy="110" r="8" fill="#2f8cff"/><text x="230" y="90" text-anchor="middle" font-size="11.5" font-weight="700" fill="#2f8cff">Transformer</text><text x="230" y="132" text-anchor="middle" font-size="9.5" fill="#6b7280">2017</text><circle cx="305" cy="110" r="7" fill="#0b5394"/><text x="305" y="90" text-anchor="middle" font-size="11.5" font-weight="700" fill="#1c1d1f">Chat</text><text x="305" y="132" text-anchor="middle" font-size="9.5" fill="#6b7280">2022</text></svg>',
      explanation:
    ...
    },
    {
      ...
      caption:
        'An LLM is not a search engine, a database, or the chatbot wrapped around it. It generates plausible text, so watch for an old training cutoff and confident wrong answers.',
      svg:
        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 200" width="100%" preserveAspectRatio="xMidYMid meet" role="img" font-family="system-ui, -apple-system, Helvetica, Arial, sans-serif"><title>What an LLM is not: search engine, database, or chatbot</title><rect x="0" y="0" width="360" height="200" rx="10" fill="#f7f3ea"/><text x="180" y="22" text-anchor="middle" font-size="14" font-weight="700" fill="#1c1d1f">What it is not</text><rect x="12" y="74" width="70" height="56" rx="8" fill="#efe9da" stroke="#0b5394" stroke-width="1.6"/><text x="47" y="100" text-anchor="middle" font-size="12" font-weight="700" fill="#0b5394">LLM</text><text x="47" y="115" text-anchor="middle" font-size="8.5" fill="#6b7280">generates text</text><line x1="82" y1="102" x2="150" y2="57" stroke="#6b7280" stroke-width="1.4"/><line x1="82" y1="102" x2="150" y2="103" stroke="#6b7280" stroke-width="1.4"/><line x1="82" y1="102" x2="150" y2="149" stroke="#6b7280" stroke-width="1.4"/><text x="113" y="74" text-anchor="middle" font-size="12" font-weight="700" fill="#dc2626">x</text><text x="116" y="98" text-anchor="middle" font-size="12" font-weight="700" fill="#dc2626">x</text><text x="113" y="130" text-anchor="middle" font-size="12" font-weight="700" fill="#dc2626">x</text><rect x="150" y="40" width="196" height="34" rx="6" fill="#ffffff" stroke="#e6dfce" stroke-width="1.5"/><text x="160" y="56" font-size="11" font-weight="700" fill="#1c1d1f">Search engine</text><text x="160" y="68" font-size="9" fill="#6b7280">looks up and links real documents</text><rect x="150" y="86" width="196" height="34" rx="6" fill="#ffffff" stroke="#e6dfce" stroke-width="1.5"/><text x="160" y="102" font-size="11" font-weight="700" fill="#1c1d1f">Database</text><text x="160" y="114" font-size="9" fill="#6b7280">stores and returns exact records</text><rect x="150" y="132" width="196" height="34" rx="6" fill="#ffffff" stroke="#e6dfce" stroke-width="1.5"/><text x="160" y="148" font-size="11" font-weight="700" fill="#1c1d1f">Chatbot</text><text x="160" y="160" font-size="9" fill="#6b7280">the whole product around the model</text><text x="180" y="190" text-anchor="middle" font-size="9" fill="#d97706">watch for: training cutoff and hallucinations</text></svg>',
      explanation:
